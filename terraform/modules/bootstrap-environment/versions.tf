...
# Must run — and its state must exist — before dev/staging/monitoring,
# since those rely on the Argo CD Application CRD this installs being
# registered in the cluster already.
terraform {

...
variable "repo_url" {
  description = "Git URL of this repo (stock-infrastructure), the source Argo CD tracks for both the Helm chart and secrets/dev/."
  type        = string
  default     = "https://github.com/theadonata/stock-infrastructure.git"
}

variable "target_revision" {
  description = "Git branch Argo CD tracks for dev."
  type        = string
  default     = "main"
}
